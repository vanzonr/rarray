...
\end{enumerate}
The last example intentionally also has side effects, as the original rarray that was passed to the dump function now has a different shape.  The first method is therefore usually preferred when dealing with command line arguments.
