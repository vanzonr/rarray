...
The \texttt{reshape} method fails if the rarray is an original rarray, to protect existing shallo copies. If no such copies exist, one can use the \texttt{reshape\_force} method to reshape an original array.
